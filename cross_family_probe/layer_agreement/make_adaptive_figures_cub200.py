...
out_dir = Path("outputs/cub200/figures")
...
ax.set_ylabel("CUB-200 (4-way) accuracy (%)")
ax.set_title("Per-example adaptive depth vs. fixed uniform pruning (CUB-200)")
...
ax.set_xlabel("average number of decoder layers executed (of 28)")
ax.set_ylabel("CUB-200 (4-way) accuracy (%)")
ax.set_title("Zoomed: low-to-mid average depth (CUB-200)")
ax.legend(frameon=False, fontsize=9, loc="lower right")
ax.set_xlim(0, 18)
fig.tight_layout()
