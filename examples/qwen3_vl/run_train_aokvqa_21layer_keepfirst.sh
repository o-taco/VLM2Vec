#!/bin/bash
# Contiguous-drop counterpart to run_train_aokvqa_21layer.sh: keep the first
# 21 layers (0..20), drop the contiguous tail, instead of the alternating
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-21layer-keepfirst \
  ...
  --output_dir output/aokvqa_qwen3vl_21layer_keepfirst \
