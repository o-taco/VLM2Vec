#!/bin/bash
# Contiguous-drop counterpart to run_train_aokvqa_7layer.sh: keep the first
# 7 layers (0..6), drop the contiguous tail, instead of the alternating
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-7layer-keepfirst \
  ...
  --output_dir output/aokvqa_qwen3vl_7layer_keepfirst \
