...
# (deepstack recipients) plus the tail 10..27, dropping layers 3-9
# (7 layers, 25pct of 28) -- opposite end from keepfirst, at the same
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-21layer-keeplast \
  ...
  --output_dir output/aokvqa_qwen3vl_21layer_keeplast \
