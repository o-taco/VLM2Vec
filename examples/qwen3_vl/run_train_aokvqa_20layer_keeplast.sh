...
# (deepstack recipients) plus the tail 11..27, dropping layers 3-10
# (8 layers, 28.6pct of 28) -- opposite end from keepfirst, at the same
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-20layer-keeplast \
  ...
  --output_dir output/aokvqa_qwen3vl_20layer_keeplast \
