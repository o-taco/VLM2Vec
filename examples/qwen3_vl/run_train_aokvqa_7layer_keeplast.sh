...
# (deepstack recipients) plus the tail 24..27, dropping layers 3-23
# (21 layers, 75pct of 28) -- opposite end from keepfirst, at the same
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-7layer-keeplast \
  ...
  --output_dir output/aokvqa_qwen3vl_7layer_keeplast \
