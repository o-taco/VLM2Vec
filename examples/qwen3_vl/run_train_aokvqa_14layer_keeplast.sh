...
# (deepstack recipients) plus the tail 17..27, dropping layers 3-16
# (14 layers, 50pct of 28) -- opposite end from keepfirst, at the same
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-14layer-keeplast \
  ...
  --output_dir output/aokvqa_qwen3vl_14layer_keeplast \
