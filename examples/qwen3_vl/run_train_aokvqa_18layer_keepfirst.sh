#!/bin/bash
# Contiguous-drop counterpart to run_train_aokvqa_18layer.sh: keep the first
# 18 layers (0..17), drop the contiguous tail, instead of the alternating
...
python train.py \
  --model_name pruned_models/qwen3vl-2b-18layer-keepfirst \
  ...
  --output_dir output/aokvqa_qwen3vl_18layer_keepfirst \
